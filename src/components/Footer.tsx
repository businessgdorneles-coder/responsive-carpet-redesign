    ...
    <footer className="bg-dark-section border-t border-white/10">
      ...
      <div className="container max-w-4xl py-10">
        <div className="grid sm:grid-cols-3 gap-8 mb-8 text-center sm:text-left">
          ...
          <div>
            ...
            <div className="space-y-2">
              ...
              <a href="mailto:contato@primetap.com.br" className="flex items-center gap-2 text-white/50 hover:text-white text-xs transition-colors justify-center sm:justify-start">
                <Mail className="w-3.5 h-3.5 text-primary" /> contato@primetap.com.br
              </a>
              ...
              <a href="https://instagram.com/primetap_brasil" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-white/50 hover:text-white text-xs transition-colors justify-center sm:justify-start">
                <Instagram className="w-3.5 h-3.5 text-primary" /> @primetap_brasil
              </a>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="space-y-2">
              <p className="text-white/50 text-xs">PrimeTAP Centro Automotivo LTDA</p>
        ...
        <div className="border-t border-white/10 pt-6 flex flex-col sm:flex-row items-center justify-between gap-3">
          ...
          <a href="https://instagram.com/primetap_brasil" target="_blank" rel="noopener noreferrer" className="flex items-center gap-1.5 text-white/40 hover:text-white/70 transition-colors">
            <Instagram className="w-4 h-4" />
            <span className="text-[11px]">@primetap_brasil</span>
          </a>
          <p className="text-white/20 text-[10px]">
            &copy; {new Date().getFullYear()} PrimeTAP LTDA. Todos os direitos reservados.
          </p>
        </div>
      </div>
    </footer>
